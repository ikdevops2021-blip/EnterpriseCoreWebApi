...
class _NotificationConfigViewState extends ConsumerState<NotificationConfigView> {
              ...
              if (isMobile) ...[
                    ...
                    onPressed: () {
                      setState(() {
                        _selectedConfig = const NotificationConfigModel(
                          channelId: 999,
                          channelName: 'New Notification Channel',
                ...
                Row(
                  children: [
                    Expanded(
                      child: DqmsTextField(
                        hintText: 'Search Notification Channels or Providers...',
                        prefixIcon: const Icon(Icons.search_rounded, size: 18),
                        onChanged: (val) {
                          setState(() {
                            _searchQuery = val;
                  ...
                  child: isMobile
                      ? ListView.separated(
                          ...
                          itemBuilder: (ctx, i) {
                            ...
                            return _buildMobileNotificationCard(notif, isSelected);
                          },
                        )
  ...
  Widget _buildMobileNotificationCard(NotificationConfigModel notif, bool isSelected) {
    return InkWell(
      onTap: () {
        setState(() {
          _selectedConfig = notif;
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Spacer(),
                const Icon(Icons.replay_rounded, size: 13, color: AppColors.textSubtle),
